 ...
 */
@Entity
@Table(name = "vehiculosimagenes")
public class VehiculosImagenes implements Serializable{
    @Id
    ...
    public int hashCode() {
        int hash = 7;
        hash = 41 * hash + Objects.hashCode(this.idimagenveh);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final VehiculosImagenes other = (VehiculosImagenes) obj;
    ...
    public String toString() {
        return "VehiculosImagenes{" + "idimagenveh=" + idimagenveh + '}';
    }
