...
public class AudioIController {
    ...
    private ImportacionesViewDAO vistaImportacion;
     ...
     public Importador obtenerImportadorByUsuario(Usuario u){
        ...
        @RequestMapping("/imagenVeh/importacionesA")
	public ModelAndView ListImportacionesVeh(HttpSession session){
           ...
           if(u.getIdrol()==3){
            ...
            return new ModelAndView("imagenveh/audio/busquedaVehImportacion").addObject("usuario",u).addObject("importaciones",list);
           }
           else{
         ...
         @RequestMapping("/imagenVeh/findA/{idimport}")
	public ModelAndView vehiculosImportacionImg(@PathVariable int idimport, HttpSession session) {
              ...
              // List<Vehiculos> veview = vistaVehiculo.findByidimport(idimport);
               return new ModelAndView("/imagenVeh/audio/busquedaVehiculos").addObject("usuario",u).addObject("vehiculo",vehiculos).addObject("idimport",idimport);
	}
        
        @RequestMapping("/imagenveh/agregarA/{idvehiculo}")
	public ModelAndView multimediaImagenes(@PathVariable int idvehiculo, HttpSession session) {
          ...
          return new ModelAndView("/imagenveh/audio/agregarAudio").addObject("usuario",u).addObject("imagenveh",multimedia);
        }
        
        
          //===============================AUDIO=================================================
//=======================fUNCIONA CON UNA IMAGEN================================================
@RequestMapping(value = "/uploadVentaAudio", method=RequestMethod.POST)
...
FileInputStream fis = null;
  ...
  return "redirect:/imagenveh/audio/"+ve.getIdvehiculo();
 }

  @RequestMapping("/imagenveh/audio/{idvehiculo}")
	public String ListImagenes(@PathVariable int idvehiculo, HttpSession session,Model model){
            ...
            return "imagenveh/audio/mostrarAudio";
    }
